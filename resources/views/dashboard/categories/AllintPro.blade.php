...
@section('title', 'قطع غيار داخلية')
@section('breadcrumb')
    @parent
    <li class="breadcrumb-item active">قطع غيار داخلية</li>
@endsection
@section('content')
    <x-alert />
    <hr>
    ...
    <h2>قطع غيار داخلية</h2> <!-- عنوان القسم الجديد -->
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                            {{-- يمكن إلغاء تعليق هذه الأزرار إذا كنت بحاجة إليها --}}
